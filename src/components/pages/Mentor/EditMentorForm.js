...
import {
  fetchMentorProfile as fetchMentorProfileAction,
...
const EditMenteeForm = ({
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      dob: moment(currentMentor.dob),
      academic_description: currentMentor.academic_description,
      support_needed: currentMentor.academic_description,
      primary_language: currentMentor.primary_language,
      time_zone: currentMentor.availability.time_zone,
      as_early_as: moment(currentMentor.availability.as_early_as, 'HH:mm'),
      as_late_as: moment(currentMentor.availability.as_late_as, 'HH:mm'),
    });
  }, [currentMentor, form]);
        ...
        <Col className="gutter-row" span={24}>
          ...
          >
            <Input
              type="text"
              name="first_name"
              value={currentMentor ? currentMentor.first_name : ''}
          ...
          <Form.Item label="Methods" name="method">
            <Checkbox.Group
              name="methods"
              values={currentMentor.availability.methods}
